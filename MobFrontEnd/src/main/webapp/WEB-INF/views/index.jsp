...
<div id="myCarousel" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active" style="max-width:100%;">
        <img src="http://b.dryicons.com/files/graphics_previews/mobile-shopping-retro-design.jpg" style="width:100%; max-height:90vh;" alt="Image">
...
<div class="container text-center">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <img src="http://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image">
      <p>Mob Store Assured</p>
    </div>
  </div>
</div><br>

<footer class="container-fluid text-center">
  <p>&copy; Copyright 2016 , Mob Store .<p>
</footer>
